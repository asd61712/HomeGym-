...
<!-- 註冊畫面彈跳視窗 -->
	<form method="POST" action="<c:url value='/saveStaff.do' />" enctype='multipart/form-data'>
	            ...
	            <div class="row row-cols-2">
	                <div class="col mb-3">
	                    <div class="d-flex">
	                      ...
	                      <input class="form-control me-2" id="inputMemberName" name="staffName" value="${param.staffName}" type="text" placeholder="" aria-label="Search">
	                    </div>
	                </div>
	                <div class="col mb-3">
	                    <div class="d-flex">
	                      ...
	                      <input class="form-control me-2" id="inputMemberName" name="staffPhone" value="${param.staffPhone}" type="text" placeholder="" aria-label="Search">
	                    </div>
	                </div>
	                <div class="col mb-3">
	                    <div class="d-flex">
	                      ...
	                      <input class="form-control me-2" id="inputMemberName" name="staffBirthday" value="${param.staffBirthday}" type="date" placeholder="" aria-label="Search">
	                    </div>
	                </div>
	                <div class="col mb-3">
	                    <div class="d-flex">
	                      ...
	                      <select class="form-select me-3" aria-label="Default select example" name="staffPosition" value="${param.staffPosition}">
	                ...
	                <div class="col mb-3">
	                    <div class="d-flex">
	                      ...
	                      <input class="form-control me-2" id="inputMemberName" name="staffPassword" value="${param.staffPassword}" type="password" placeholder="" aria-label="Search">
